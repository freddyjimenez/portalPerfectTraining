...
public class ClienteJpaController implements Serializable {
    ...
    public void create(Cliente cliente) throws IllegalOrphanException, PreexistingEntityException, RollbackFailureException, Exception {
        List<String> illegalOrphanMessages = null;
        Usuario usuarioOrphanCheck = cliente.getUsuario();
        if (usuarioOrphanCheck != null) {
            Cliente oldClienteOfUsuario = usuarioOrphanCheck.getCliente();
            if (oldClienteOfUsuario != null) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("The Usuario " + usuarioOrphanCheck + " already has an item of type Cliente whose usuario column cannot be null. Please make another selection for the usuario field.");
            }
        }
        if (illegalOrphanMessages != null) {
        ...
        try {
            ...
            if (usuario != null) {
                usuario = em.getReference(usuario.getClass(), usuario.getRut());
        ...
        try {
            ...
            if (usuarioNew != null && !usuarioNew.equals(usuarioOld)) {
                ...
                if (oldClienteOfUsuario != null) {
                    ...
                    illegalOrphanMessages.add("The Usuario " + usuarioNew + " already has an item of type Cliente whose usuario column cannot be null. Please make another selection for the usuario field.");
                }
            }
            if (illegalOrphanMessages != null) {
                throw new IllegalOrphanException(illegalOrphanMessages);
            ...
            if (usuarioNew != null) {
                usuarioNew = em.getReference(usuarioNew.getClass(), usuarioNew.getRut());
